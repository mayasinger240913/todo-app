...
const CHAT_FAQ = [
  ...
  {
    k: ["להתקין", "התקנה", "התקין", "טלפון", "מסך הבית", "אפליקצי", "להוריד", "אייקון", "שיתוף"],
    a: "התקנה בטלפון 📲\n" +
       "רוצים שהאפליקציה תהיה עם אייקון על המסך, כמו אפליקציה אמיתית? ככה עושים:\n\n" +
       "📱 באייפון (Safari):\n" +
       "1. פותחים את כתובת האתר בדפדפן Safari.\n" +
       "2. לוחצים על כפתור השיתוף למטה — ריבוע עם חץ כלפי מעלה ⬆️.\n" +
       "3. גוללים למטה ובוחרים \"הוסף למסך הבית\".\n" +
       "4. לוחצים \"הוסף\" — וזהו! 🎉\n\n" +
       "🤖 באנדרואיד (Chrome):\n" +
       "1. פותחים את כתובת האתר בדפדפן Chrome.\n" +
       "2. לוחצים על שלוש הנקודות ⋮ בפינה למעלה.\n" +
       "3. בוחרים \"הוסף למסך הבית\" (או \"התקן אפליקציה\").\n" +
       "4. מאשרים — והאייקון מופיע על המסך! 🎉",
  },
  {
    k: ["למחוק", "מחיק", "להסיר"],
    a: "מחיקה 🗑️\n" +
...
function chatAnswer(text) {
  ...
  // ברכה — אם המשתמש רק מברך, מחזירים ברכה חמה בחזרה 👋
  const cleaned = t.replace(/[!?.,\s]/g, "");
  const greetings = [
    "היי", "הי", "הייי", "היייי", "שלום", "שלוםם", "הלו", "אהלן", "אהלן",
    "מהנשמע", "מהקורה", "מהמצב", "בוקרטוב", "ערבטוב", "לילהטוב", "צהריםטובים",
    "hi", "hii", "hello", "helo", "hey", "yo", "shalom",
  ];
  if (greetings.includes(cleaned)) {
    return "היי! 👋😊 אני העוזר של 2DO, כיף שכתבת! 💜\n" +
           "אפשר לשאול אותי כל דבר על האפליקציה — איך הילדים נכנסים, איך מוסיפים מטלה, " +
           "מה זה הפרסים, שכחתי סיסמה, או איך מתקינים בטלפון. במה אפשר לעזור?";
  }
